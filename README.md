# This is my package laravel-claude-monitor
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-claude-monitor.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-claude-monitor)
...
```bash
php artisan vendor:publish --tag="laravel-claude-monitor-views"
```

## Usage

```php
$claudeMonitor = new EnricoDeLazzari\ClaudeMonitor();
echo $claudeMonitor->echoPhrase('Hello, EnricoDeLazzari!');
```
